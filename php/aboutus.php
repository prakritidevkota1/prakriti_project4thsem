...
<body>
    ...
    <div class="featured-Products">
        ...
        <div class="clothes-picture">
            <div class="cloth"> 
                <img src="image/aakash.jpg">
            <h5>SATIN DRESS</h5>
            <p>Price:Rs 2500</p></div>
           
            <div class="cloth">
                <img src="image/suzina.jpg">
            <h4>DENIM FIT</h4>
        <p>Price:Rs 3200</p></div>
                <div class="cloth"><image src="image/white.jpg" alt="Clothes Picture">
                    <h4>WHITE HALF SLEEVE SHIRT</h4>
                    <p>Price:Rs 1500</p>
            </div>     
            <div class="cloth">
                <img src="image/sudip.jpg">
            <h4>BLAZER SET</h4>
        <p>Price:Rs 2500</p></div>
