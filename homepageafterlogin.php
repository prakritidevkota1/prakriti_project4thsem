    ...
    <div class="main-container ">
      <ul>
        ...
        <div class="midinfo">
          ...
          <li><a href="aboutus.php">Order</a></li>
          <li><a href="contactus.php">Contactus</a></li>


        </div>

        <div class="signin-login" style="display:flex;">
          <?php $qry = "SELECT * FROM userdetails WHERE user_email = '$user_email'";
          $result = mysqli_query($conn, $qry);
          $data = mysqli_fetch_assoc($result);

          ?>
          <div>
            <h5>WELCOME!</h5><span style="color:darkblue;"><?php echo $data['user_name']; ?></span>
          </div>
          <div>
